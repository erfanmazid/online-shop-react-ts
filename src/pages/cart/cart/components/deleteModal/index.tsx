...
export default function CartDeleteModal({
  ...
  return (
    <div className="w-screen h-screen absolute top-0 left-0 bg-black bg-opacity-70 flex justify-center items-center transition-opacity duration-300 ease-in-out p-7 z-[999]">
